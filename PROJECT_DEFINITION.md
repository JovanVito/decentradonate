# Project Definition — Decentradonate

Dokumen ini adalah output resmi tahap **Define** (Minggu 1–3) sesuai
silabus Mobile Programming: mendefinisikan masalah, target pengguna,
manfaat, dan batasan scope proyek selama 12 minggu (12 pertemuan).
...
- **Tidak ada derivasi wallet BIP-44 penuh** yang kompatibel dengan
  MetaMask/Trust Wallet (lihat batasan teknis di `STRUCTURE.md`) —
  wallet dibuat dan dipakai sepenuhnya mandiri di dalam aplikasi ini.
- **Tidak ada dukungan mainnet/produksi.** Aplikasi tetap berjalan di
  Polygon Amoy Testnet selama masa pengembangan dan demo — bukan
  ditujukan untuk transaksi dana sungguhan.
